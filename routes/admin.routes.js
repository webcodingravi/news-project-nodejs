...
import { allComments, updateCommentStatus, deleteComments } from "../controller/comment.controller.js"
import isLoggedIn from "../middleware/isLogin.middleware.js"
import isAdmin from "../middleware/isAdmin.middleware.js"
import upload from "../middleware/multer.js"
import { loginValidation, UserValidation, UserUpdateValidation, CategoryValidation, ArticleValidation } from "../middleware/validation.js"
...
adminRouter.post('/index', loginValidation, adminLogin);
...
adminRouter.post('/add-user', isLoggedIn, isAdmin, UserValidation, addUser);
adminRouter.get('/update-user/:id', isLoggedIn, isAdmin, updateUserPage);
adminRouter.post('/update-user/:id', isLoggedIn, isAdmin, UserUpdateValidation, updateUser);
...
adminRouter.post('/add-category', isLoggedIn, isAdmin, CategoryValidation, addCategory);
adminRouter.get('/update-category/:id', isLoggedIn, isAdmin, updateCategoryPage);
adminRouter.post('/update-category/:id', isLoggedIn, isAdmin, CategoryValidation, updateCategory);
...
adminRouter.post('/add-article', isLoggedIn, upload.single('image'), ArticleValidation, addArticle);
adminRouter.get('/update-article/:id', isLoggedIn, updateArticlePage);
adminRouter.post('/update-article/:id', isLoggedIn, upload.single('image'), ArticleValidation, updateArticle);
adminRouter.delete('/delete-article/:id', isLoggedIn, deleteArticle);

// Comment Routes
adminRouter.get('/comments', isLoggedIn, allComments);
adminRouter.put('/update-comment-status/:id', isLoggedIn, updateCommentStatus);
adminRouter.get('/delete-comments/:id', isLoggedIn, deleteComments);
